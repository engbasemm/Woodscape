...
class ResidualBlockWithStride(nn.Module):
    ...
    def __init__(self, in_ch, out_ch, stride=2 , padding = 1):
        super().__init__()
        self.conv1 = conv3x3(in_ch, out_ch, stride=stride , padding = padding)
...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, in_ch, out_ch,padding=1):
        super().__init__()
        self.conv1 = conv3x3(in_ch, out_ch,padding=padding)
        self.leaky_relu = nn.LeakyReLU(inplace=True)
        self.conv2 = conv3x3(out_ch, out_ch)
        if in_ch != out_ch:
