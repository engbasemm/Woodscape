...
class DistanceSemanticMotionModelBase(DistanceSemanticModelBase, MotionInit):
    ...
    def distance_semantic_motion_loss_predictions(self, inputs, dist_mode = 'train'):
        losses = dict()
        # -- SEMANTIC SEGMENTATION --
        outputs, features = self.predict_semantic_seg(inputs)

        # -- MOTION SEGMENTATION --
        motion_predictions = self.predict_motion_seg(inputs, features=features,  mode = dist_mode)
