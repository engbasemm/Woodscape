    ...
    #                        child.running_var = None
            ...
            if (self.load_compression_model == True) :
                if self.compression_decoder == "factorized_prior":
                    ...
                    loaded_dict = torch.load('./models/AEs/results_models_resnet_ae/compression_scale_prior_Q8.pth')
    ...
    def compression_train(self):
        ...
        for self.epoch in range(self.args.epochs):
            ...
            if(self.training_loss  < self.best_compression_loss ) :
                if self.compression_decoder == "factorized_prior":
                    torch.save(self.models["compression"].state_dict(), './models/AEs/results_models_resnet_ae/compression_cheng_Q8_2023.pth')
                else:
